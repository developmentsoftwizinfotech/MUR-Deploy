...
var OrganizationChartNode = /*#__PURE__*/function () {
  function OrganizationChartNode(chart, cd) {
    var _this = this;
    (0,C_Data_Nitesh_personal_Git_Pages_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this, OrganizationChartNode);
    this.cd = cd;
    this.chart = chart;
  ...
  (0,C_Data_Nitesh_personal_Git_Pages_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_2__["default"])(OrganizationChartNode, [{
    key: "leaf",
    get: function get() {
...
var OrganizationChart = /*#__PURE__*/function () {
  function OrganizationChart(el, cd) {
    (0,C_Data_Nitesh_personal_Git_Pages_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this, OrganizationChart);
    this.el = el;
    this.cd = cd;
  ...
  (0,C_Data_Nitesh_personal_Git_Pages_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_2__["default"])(OrganizationChart, [{
    key: "selection",
    get: function get() {
      ...
      if (eventTarget.className && (eventTarget.className.indexOf('p-node-toggler') !== -1 || eventTarget.className.indexOf('p-node-toggler-icon') !== -1)) {
        ...
        if (this.selectionMode === 'single') {
          ...
          if (selected) {
            ...
            this.selection = [].concat((0,C_Data_Nitesh_personal_Git_Pages_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(this.selection || []), [node]);
            this.onNodeSelect.emit({
              originalEvent: event,
              node: node
            });
...
var OrganizationChartModule = /*#__PURE__*/(0,C_Data_Nitesh_personal_Git_Pages_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_2__["default"])(function OrganizationChartModule() {
  (0,C_Data_Nitesh_personal_Git_Pages_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this, OrganizationChartModule);
});
